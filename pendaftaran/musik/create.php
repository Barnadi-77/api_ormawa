...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/musik/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO musik (nama, nim, email, kelas, angkatan, kontak, prodi, motivasi, foto_diri, ktm) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
