...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/futsal/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO futsal (nama, nim, email, kelas, angkatan, kontak, prodi, motivasi, foto_diri, ktm) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
