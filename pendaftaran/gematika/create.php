...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/gematika/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO gematika (nama, nim, email, kelas, angkatan, kontak, prodi, motivasi, foto_diri, ktm) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
