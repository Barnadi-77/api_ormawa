...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/adcom/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO adcom (nama, nim, email, kelas, angkatan, kontak, prodi, motivasi, foto_diri, ktm, subscribe_yt, follow_ig) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
