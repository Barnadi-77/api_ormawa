...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/dpm/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO dpm (nama, nim, email, kelas, jabatan, angkatan, kontak, prodi, motivasi, foto_diri, ktm, follow_ig) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
