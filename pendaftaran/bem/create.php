...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/bem/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO bem (nama, nim, email, kelas, jabatan, angkatan, kontak, prodi, motivasi, foto_diri, ktm, follow_ig) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
