...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/icgd/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO icgd (nama, nim, email, kelas, angkatan, kontak, prodi, motivasi, foto_diri, ktm, subscribe_yt, follow_ig) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
