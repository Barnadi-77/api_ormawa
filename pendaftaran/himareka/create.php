...
function uploadFile($inputName, $targetFolder)
{
    ...
    $uploadDir = __DIR__ . "/../../uploads/himareka/$targetFolder/";
...
// Simpan ke database
$stmt = $conn->prepare("INSERT INTO himareka (nama, nim, email, kelas, angkatan, kontak, prodi, motivasi, foto_diri, ktm) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
