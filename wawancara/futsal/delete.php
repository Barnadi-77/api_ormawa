...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm FROM futsal WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/futsal/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/futsal/ktm/'],
        ];
        ...
        $queryDelete = "DELETE FROM futsal WHERE id = ?";
