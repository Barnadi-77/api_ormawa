...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm FROM badminton WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/badminton/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/badminton/ktm/'],
        ];
        ...
        $queryDelete = "DELETE FROM badminton WHERE id = ?";
