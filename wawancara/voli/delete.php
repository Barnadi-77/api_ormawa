...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm FROM voli WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/voli/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/voli/ktm/'],
        ];
        ...
        $queryDelete = "DELETE FROM voli WHERE id = ?";
