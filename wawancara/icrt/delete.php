...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm, subscribe_yt, follow_ig FROM pendaftar WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/icrt/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/icrt/ktm/'],
            ['filename' => $row['subscribe_yt'], 'folder' => '../../uploads/icrt/subscribe_yt/'],
            ['filename' => $row['follow_ig'], 'folder' => '../../uploads/icrt/follow_ig/'],
        ];
        ...
        $queryDelete = "DELETE FROM pendaftar WHERE id = ?";
