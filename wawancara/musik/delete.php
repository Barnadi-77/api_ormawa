...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm FROM musik WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/musik/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/musik/ktm/'],
        ];
        ...
        $queryDelete = "DELETE FROM musik WHERE id = ?";
