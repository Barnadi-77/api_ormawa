...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm, subscribe_yt, follow_ig FROM himsi WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/himsi/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/himsi/ktm/'],
            ['filename' => $row['subscribe_yt'], 'folder' => '../../uploads/himsi/subscribe_yt/'],
            ['filename' => $row['follow_ig'], 'folder' => '../../uploads/himsi/follow_ig/'],
        ];
        ...
        $queryDelete = "DELETE FROM himsi WHERE id = ?";
