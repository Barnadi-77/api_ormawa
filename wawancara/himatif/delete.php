...
if (!empty($id)) {
    ...
    $querySelect = "SELECT foto_diri, ktm, subscribe_yt, follow_ig FROM himatif WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $files = [
            ['filename' => $row['foto_diri'], 'folder' => '../../uploads/himatif/foto_diri/'],
            ['filename' => $row['ktm'], 'folder' => '../../uploads/himatif/ktm/'],
            ['filename' => $row['subscribe_yt'], 'folder' => '../../uploads/himatif/subscribe_yt/'],
            ['filename' => $row['follow_ig'], 'folder' => '../../uploads/himatif/follow_ig/'],
        ];
        ...
        $queryDelete = "DELETE FROM himatif WHERE id = ?";
